...
# source: protod/database_create.proto
...
_CREATEDATABASERESPONSE_FAILURECODE = _descriptor.EnumDescriptor(
  name='FailureCode',
  full_name='protodb.protod.CreateDatabaseResponse.FailureCode',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_CREATEDATABASEREQUEST = _descriptor.Descriptor(
  ...
  full_name='protodb.protod.CreateDatabaseRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='protodb.protod.CreateDatabaseRequest.name', index=0,
...
_CREATEDATABASERESPONSE = _descriptor.Descriptor(
  ...
  full_name='protodb.protod.CreateDatabaseResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='success', full_name='protodb.protod.CreateDatabaseResponse.success', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='failure_code', full_name='protodb.protod.CreateDatabaseResponse.failure_code', index=1,
...
CreateDatabaseRequest = _reflection.GeneratedProtocolMessageType('CreateDatabaseRequest', (_message.Message,), dict(
  ...
  __module__ = 'protod.database_create_pb2'
  # @@protoc_insertion_point(class_scope:protodb.protod.CreateDatabaseRequest)
  ))
...
CreateDatabaseResponse = _reflection.GeneratedProtocolMessageType('CreateDatabaseResponse', (_message.Message,), dict(
  ...
  __module__ = 'protod.database_create_pb2'
  # @@protoc_insertion_point(class_scope:protodb.protod.CreateDatabaseResponse)
  ))
