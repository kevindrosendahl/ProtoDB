...
# source: protodb/collection_create.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='protodb/collection_create.proto',
  package='protodb',
  syntax='proto3',
  serialized_pb=_b('\n\x1fprotodb/collection_create.proto\x12\x07protodb\x1a google/protobuf/descriptor.proto\"k\n\x17\x43reateCollectionRequest\x12\x10\n\x08\x64\x61tabase\x18\x01 \x01(\t\x12\x0c\n\x04name\x18\x02 \x01(\t\x12\x30\n\x06schema\x18\x03 \x01(\x0b\x32 .google.protobuf.DescriptorProto\"\xe0\x01\n\x18\x43reateCollectionResponse\x12\x0f\n\x07success\x18\x01 \x01(\x08\x12\x43\n\x0c\x66\x61ilure_code\x18\x02 \x01(\x0e\x32-.protodb.CreateCollectionResponse.FailureCode\"n\n\x0b\x46\x61ilureCode\x12\x0c\n\x08NO_ERROR\x10\x00\x12\x0e\n\nINVALID_DB\x10\x01\x12\x16\n\x12INVALID_COLLECTION\x10\x02\x12\x15\n\x11\x43OLLECTION_EXISTS\x10\x03\x12\x12\n\x0eINVALID_SCHEMA\x10\x04\x62\x06proto3')
  ,
...
_CREATECOLLECTIONRESPONSE_FAILURECODE = _descriptor.EnumDescriptor(
  name='FailureCode',
  full_name='protodb.CreateCollectionResponse.FailureCode',
  filename=None,
  file=DESCRIPTOR,
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INVALID_SCHEMA', index=4, number=4,
      options=None,
      type=None),
  ],
...
_CREATECOLLECTIONREQUEST = _descriptor.Descriptor(
  ...
  full_name='protodb.CreateCollectionRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='database', full_name='protodb.CreateCollectionRequest.database', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='protodb.CreateCollectionRequest.name', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='schema', full_name='protodb.CreateCollectionRequest.schema', index=2,
...
_CREATECOLLECTIONRESPONSE = _descriptor.Descriptor(
  ...
  full_name='protodb.CreateCollectionResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='success', full_name='protodb.CreateCollectionResponse.success', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='failure_code', full_name='protodb.CreateCollectionResponse.failure_code', index=1,
...
CreateCollectionRequest = _reflection.GeneratedProtocolMessageType('CreateCollectionRequest', (_message.Message,), dict(
  ...
  __module__ = 'protodb.collection_create_pb2'
  # @@protoc_insertion_point(class_scope:protodb.CreateCollectionRequest)
  ))
...
CreateCollectionResponse = _reflection.GeneratedProtocolMessageType('CreateCollectionResponse', (_message.Message,), dict(
  ...
  __module__ = 'protodb.collection_create_pb2'
  # @@protoc_insertion_point(class_scope:protodb.CreateCollectionResponse)
  ))
