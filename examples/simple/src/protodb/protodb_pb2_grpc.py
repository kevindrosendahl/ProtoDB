...
class ProtoDBStub(object):
  ...
  def __init__(self, channel):
    ...
    self.CreateCollection = channel.unary_unary(
        ...
        request_serializer=protodb_dot_collection__create__pb2.CreateCollectionRequest.SerializeToString,
        response_deserializer=protodb_dot_collection__create__pb2.CreateCollectionResponse.FromString,
        )
...
def add_ProtoDBServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'CreateCollection': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=protodb_dot_collection__create__pb2.CreateCollectionRequest.FromString,
          response_serializer=protodb_dot_collection__create__pb2.CreateCollectionResponse.SerializeToString,
      ),
  }
